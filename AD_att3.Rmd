...
# Corresponds to Host.AlloC. C_a 0.2 -> 0.05, Everything else is generally the same as AD_att1 **Need to fix plot breaks !!**
```{r}
...
```{r}
mutset1.7 <- matrix(NaN,nrow = 21, ncol = 21, dimnames = list(seq(0, 1, 1/20), seq(0, 1, 1/20))) #name rows to be u_m ; cols to be u_n. made a matrix thingie yay
# mutset1.7[1] <- 0.7
